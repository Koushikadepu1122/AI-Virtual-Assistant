...
function SignIn(){
    ...
    return (
        ...
        style={{backgroundImage:`url(${bg})`}}>
            ...
            items-center gap-[20px] px-[20px] ' onSubmit={handleSignIn}>
                ...
                *{err}</p>}
                ...
                font-bold text-[19px] cursor-pointer' disabled={loading} >{loading ? "Loading..." : "Sign In"}</button>

                <p className='text-white text-[16px] cursor-pointer' onClick={() => navigate("/signup")}>
                Create a new account? <span className= 'text-cyan-300 text-[18px] font-semibold'> 
                Sign Up</span></p>
