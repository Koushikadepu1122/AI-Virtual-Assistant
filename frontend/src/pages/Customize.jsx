...
function Customize() {
    ...
    return(
        <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#364751]
        flex justify-center items-center flex-col p-[20px]   '>
            ...
            Select Your <span className='text-cyan-500 font-semibold'>Assistant Image</span></h1>
        ...
        <div className={`w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] bg-[#030338] border-2 border-[#03035ac8] 
        rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-cyan-600 cursor-pointer hover:border-2 
        hover:border-white flex items-center justify-center
        ${selectedImage =="input" ? "border-3 border-white shadow-2xl shadow-cyan-600" : null}`}
         onClick={() => {
         ...
         text-black font-bold text-[19px] cursor-pointer'onClick={() =>navigate("/customize2")} >
         Next</button>}
