...
function Home() {
  ...
  const speak = (text) => {
    ...
    return(
        <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#33434d]
        flex justify-center items-center flex-col gap-[15px]  '>
            ...
            <div className={`absolute lg:hidden top-0 w-full h-full bg-[#00000015] backdrop-blur-md  p-[20px]
            flex flex-col gap-[20px] items-start ${ham ? "translate-x-0 " : 
            ...
            font-bold text-[19px] cursor-pointer px-[20px] py-[10px] ' onClick={() => navigate("/customize")}>
            Customize Your Assistant</button>

            <button className='min-w-[150px] h-[60px] bg-white rounded-full text-black 
            font-bold text-[19px] cursor-pointer '
            ...
            <div className='w-full h-[400px] overflow-y-auto flex flex-col gap-[10px] '>
            ...
            font-bold text-[19px] absolute top-[20px] right-[20px] hidden lg:block cursor-pointer px-[20px] 
            py-[10px]' onClick={() => navigate("/customize")}>
            Customize Your Assistant</button>

            <button className='min-w-[150px] h-[60px] mt-[30px] bg-white rounded-full text-black 
            font-bold text-[19px] absolute top-[100px] right-[20px] cursor-pointer hidden lg:block '
            onClick={handleLogOut} >Logout</button>
            ...
            <img src={userData?.assistantImage} alt="" className='h-full object-cover rounded-3xl' />
            ...
            {aiText && <img src={aiImg} alt="" className='w-[230px]  ' /> }
